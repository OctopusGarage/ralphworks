...
function buildRalphPrompt(job: RalphJob, iteration: number, progress: string): string {
  ...
  return [
    ...
    "",
    "Rules:",
    "- If the task has several items, choose the highest-priority unfinished item and work on one useful increment.",
    ...
    "- End with a concise handoff: item addressed, work done, files changed, and the next unfinished item or blocker.",
